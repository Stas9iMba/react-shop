...
function WidgetMainChatLeft() {
  return (
    <div className="widget-main__left">
      {/* <p> */}
       <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus dolorum qui atque culpa. Ex dolorem ipsum totam maiores consectetur consequuntur.</p>
         <div className="time">
        <span>12.43</span>
        <span>
