      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <div className="content__inner">
            <div className="card">
              ...
              <div className="card__info">
                ...
                <button className="card__btn">
                  <img width={11} height={11} src="/images/icons/button-add.svg" alt="" />
                </button>
              </div>
            </div>
            <div className="card">
              <img width={133} height={112} src="/images/product/product-2.jpg" alt="" />
              <h5 className="card__name">Мужские Кроссовки Nike Blazer Mid Suede</h5>
              <div className="card__info">
                <div className="card__info-price">
                  <span>Цена:</span>
            ...
            <div className="card">
              <img width={133} height={112} src="/images/product/product-3.jpg" alt="" />
              <h5 className="card__name">Мужские Кроссовки Nike Blazer Mid Suede</h5>
              <div className="card__info">
                <div className="card__info-price">
                  <span>Цена:</span>
            ...
            <div className="card">
              <img width={133} height={112} src="/images/product/product-4.jpg" alt="" />
              <h5 className="card__name">Мужские Кроссовки Nike Blazer Mid Suede</h5>
              <div className="card__info">
                <div className="card__info-price">
                  <span>Цена:</span>
